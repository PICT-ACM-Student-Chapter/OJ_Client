...
import {Button, Card, Col, Divider, Row, Select, Space, Spin, Typography} from "antd";
...
function QuestionDetail() {
    ...
    return (
        <Row justify="space-around" align="middle" gutter={16}>
                ...
                <Card className='question-card'>
                    ...
                    <Typography.Title level={3}>Sample Testcase(s)</Typography.Title>
                    {
                        question.test_cases.map(({input,output,id})=>(
                            ...
                            <Row  gutter={16}>
                                <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                                    <Card className='test-case-card' type="inner" title={<Typography.Title level={4}>Input</Typography.Title>} extra={<a href="#">Copy</a>}>
                                        <pre>{input}</pre>
                                    </Card>
                                </Col>
                                <Col xs={24} sm={24} md={24} lg={12} xl={12}>

                                    <Card className='test-case-card' type="inner" title={<Typography.Title level={4}>Output</Typography.Title>} extra={<a href="#">Copy</a>}>
                                        <pre>{output}</pre>
                                    </Card>
                                </Col>
                            </Row>
            ...
            <Col xs={24} sm={24} md={24} lg={12} xl={12}>
                <Card style={{ marginBottom: '16px'}} className='button-group-card'>
                ...
                <Card style={{ marginTop: '16px', marginBottom: '0px'}} className='button-group-card'>
